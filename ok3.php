...
// on post data. replace $_POST['name'] and $_POST['phone'] with correct variables
                if(!empty($_POST['name']) && !empty($_POST['phone'])) {
                  ...
                  $res = file_get_contents("https://ep.smartad.digital/api/lead/1/2?sub3=".$_SERVER['SERVER_NAME'].'_mg'."&sub2=72&sub4=4&sub5=5",false, stream_context_create(['http' =>
                  [
                  'method' => 'POST',
                  ...
                  file_put_contents("leads.log", "response: " . $res . "; data: ".json_encode($data)."", 8);
...
<p>
The operator will contact you shortly</p>
